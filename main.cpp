...
int main(int, char**)
{
    ...
    HWND hwnd = ::CreateWindowA(wc.lpszClassName,      // Window class
                                "Dear ImGui Practice", // Window title
    ...
    // io.ConfigFlags |= ImGuiConfigFlags_XXX; Add config flags
    ...
    //IM_ASSERT(font != NULL);
    io.Fonts->AddFontFromFileTTF("fonts/ubuntu-font-family-0.83/Ubuntu-R.ttf", 14.0f);
    io.Fonts->Build();
...
//! End of file, empty newline required by GCC
